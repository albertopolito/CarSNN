...
parser.add_argument('--sample_length', type=float, default=1, dest='sample_length')
parser.add_argument('--batch_size', type=int, default=1, dest='batch_size')
parser.add_argument('--lr', type=float, default=1e-3, dest='lr')
parser.add_argument('--lr_decay_epoch', type=int, default=10, dest='lr_decay')
parser.add_argument('--lr_decay_value', type=float, default=0.1, dest='lr_decay_value')
parser.add_argument('--threashold', type=float, default=0.5, dest='thresh')
